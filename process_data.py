...
def process_order_data(combined_data, purchaser_username, screenshot_date):
    ...
    try:
        ...
        prompt = (
            ...
            f"- Quantity of Tickets: The number of tickets purchased. If the quantity is provided in the text content (ex. quantity 8, qty 8, 8x, quantity 4, qty 4, 4x, and others) use the provided text over what you get in the OCR.\n"
